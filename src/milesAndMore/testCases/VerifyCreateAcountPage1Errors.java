...
public class VerifyCreateAcountPage1Errors extends TestCase{
	...
	public void run() {
		...
		List<String> currentErrors = createAcountPage1.getAllErrors();
	...
	public String getTestCaseScenario() {
		return "Verify errors counter and error messages on the first \"Create account\" page.";
	}
